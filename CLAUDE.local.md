...
**YOU ARE IN: `crm/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/crm/` (rig root) or other directories
...
**Your mail address:** `crm/polecats/obsidian`
**Your rig:** crm
**Your Witness:** `crm/witness`
...
| Ask Witness for help | `gt mail send crm/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`crm/witness`) when:
...
```bash
gt mail send crm/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
